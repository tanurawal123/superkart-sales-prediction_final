...
# Maps the deployment-facing field names (used in the API payload / batch CSV)
# to the column names the trained pipeline was fit on.
RENAME_MAP = {
...
def engineer_features(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Product_MRP_Per_Weight isn't provided directly, so it's still computed
